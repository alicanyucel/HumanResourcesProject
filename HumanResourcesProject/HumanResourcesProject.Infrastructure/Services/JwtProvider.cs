...
using HumanResourcesProject.Application.Services;
using HumanResourcesProject.Domain.Entities;
using HumanResourcesProject.Infrastructure.Options;
...
namespace HumanResourcesProject.Infrastructure.Services
{
